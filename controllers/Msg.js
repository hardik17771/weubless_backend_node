class Msg {
  responseMsg(msgId) {
    const msg = {
      ...
      422: "user id userUid is missing",
      ...
      752 : "Cart Id is missing",
      753 : "Order is placed",
      754 : "Order is completed",
      755 : "Order ID is completed",
      756 : "Product array with quantity and id is required",
      757 : "Quantity is required",
      758 : "Shops for products are different... Buy product from same shop",
      759 : "Cart is empty",
      760 : "Cannot modify the shops and total_quantity for the product via product model... If want to change then make the changes in that shop model",
      761 : "Seller Id is required",
      762 : "Shop Price is required",
      763 : "Products added to Shop successfully",
      764 : "Seller is successfully created",
      765 : "Seller not found",
      766 : "Seller details fetched",
      767 : "Product and Seller updated successfully",
      900: "Success",
      1100: "Failure",
    };
